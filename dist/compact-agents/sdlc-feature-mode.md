...
~/.claude/scripts/validators/validate-build.sh             # build the project
~/.claude/scripts/validators/validate-lint.sh              # lint + typecheck
~/.claude/scripts/validators/validate-tests.sh             # full test suite
~/.claude/scripts/validators/validate-smoke.sh             # boot server, hit known routes
~/.claude/scripts/validators/validate-deps.sh              # CVE / advisory check
~/.claude/scripts/validators/validate-code-health.sh       # anti-slop + complexity gates
~/.claude/scripts/validators/validate-module-boundaries.sh # cross-module import enforcement
```
